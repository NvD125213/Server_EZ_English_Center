...
// }
export async function aiAgentController(req, res) {
    try {
        ...
        if (bestMatch && maxSimilarity > 0.7) {
            ...
            const chatResponse = await openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: "Bạn là trợ lý ảo thân thiện hỗ trợ trung tâm tiếng Anh. Nếu bạn không biết câu trả lời chính xác, hãy lịch sự đề nghị liên hệ trung tâm.",
                    },
