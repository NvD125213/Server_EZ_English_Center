...
export const sendMailPayment = async (email, course, amount, payment_url) => {
    try {
        let transporter = nodemailer.createTransport({
            host: "smtp.gmail.com",
            port: 587,
...
export const sendPaymentConfirmation = async (email, courseName, className, startDate, amount, classSchedules, address) => {
    try {
        let transporter = nodemailer.createTransport({
            host: "smtp.gmail.com",
            port: 587,
        ...
        const scheduleText = classSchedules
            ...
            return `${weekdays[schedule.week_day - 1]}: Bắt đầu lúc ${schedule.start_time} (${schedule.hours} tiếng học)`;
        })
            .join("<br>");
        // Format address
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <p><strong>Ngày bắt đầu:</strong> ${startDate.toLocaleDateString("vi-VN")}</p>
            <p><strong>Số tiền đã thanh toán:</strong> ${amount.toLocaleString("vi-VN")} VNĐ</p>
