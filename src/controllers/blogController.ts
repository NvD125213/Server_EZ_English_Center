...
export const BlogController = {
  get: async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      const { page, limit, sort_by, sort_order, search, menu_id } =
        validatedQuery;
  ...
  getBlogForMenu: async (req: Request, res: Response): Promise<any> => {
    try {
  ...
  getTopViewed: async (req: Request, res: Response): Promise<any> => {
    try {
      const blogs = await prisma.blog.findMany({
  ...
  getRecentBlog: async (req: Request, res: Response): Promise<any> => {
    try {
      const blogs = await prisma.blog.findMany({
        where: { deleted_at: null },
