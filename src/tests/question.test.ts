...
describe("create-question", () => {
  ...
  it("should return 400 if exam_id or part_id is missing", async () => {
    ...
    await QuestionController.createQuestion(req as Request, res as Response);
  ...
  it("should create question group and questions successfully", async () => {
    (prisma.part.findUnique as jest.Mock).mockResolvedValue("Part 1");
    (prisma.exam.findUnique as jest.Mock).mockResolvedValue("Exam 1");
