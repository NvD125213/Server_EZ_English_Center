...
async function createEmbeddings() {
  const rawData = fs.readFileSync(
    "C:/CenterManagement/Server/ai/data-training.json",
    "utf8"
  );
  const faqs: any[] = JSON.parse(rawData);
...
async function addNewQuestion(question: string, answer: string) {
...
addNewQuestion(
  "Xin chào",
  "Xin chào! Tôi là trợ lý ảo của Trung tâm Tiếng Anh EZ, tôi có thể giúp gì cho bạn?"
);
